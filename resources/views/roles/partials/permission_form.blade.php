<div class="modal fade" id="rolPermisoCrudModal">
    <form id="rolPermisoCrudForm">
        @csrf
        <div class="modal-dialog modal-xl">
            <div class="modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header bg">
                        <h5 class="modal-title" id="rolPermisoCrudModalTitle"></h5>
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="button" id="rolPermisoSubmitButton" class="btn btn-info">
